    ...
    class Store {
        ...
        _withIDBStore(type, callback) {
            return this._dbp.then((db) => new Promise((resolve, reject) => {
                ...
                transaction.onerror = transaction.onabort = (event) => { var _a, _b; return reject((_a = transaction === null || transaction === void 0 ? void 0 : transaction.error) !== null && _a !== void 0 ? _a : (_b = event.target) === null || _b === void 0 ? void 0 : _b.error); };
